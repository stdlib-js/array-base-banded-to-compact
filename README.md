...
```javascript
import toCompact from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-banded-to-compact@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-banded-to-compact/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-base-banded-to-compact/actions/workflows/test.yml?query=branch:v0.1.1
